...
@ToStringRepresentation(fieldNames = {"existiertNicht", "nurToStringRelevant"})
public class TestklasseMitFalschDeklariertemToStringRepresenationNamen extends AbstractCommonObject implements Cloneable{
